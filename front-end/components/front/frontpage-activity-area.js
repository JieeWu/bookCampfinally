...
export default function FrontPageActivity() {
  ...
  const getData = async (data) => {
    try {
      await axios
        .post('http://localhost:3002/share/activity', {data}, {
            ...
            <div className='col-12 col-md-9 position-relative'>
              ...
              <div className={`${styles.btnGroup} px-3`}>
                <div className='row justify-content-around'>
                  ...
                  {/* 最新上架 */}
                  <button value="最新上架"
                    className={`${styles.actBtn} col m-bg-orange pixel-border-orange`}
                    onClick={(e) => {
                    ...
                    <div className='d-flex flex-column flex-xl-row align-items-center'>
                      ...
                      <select className={`${styles.formSelect} d-none d-md-flex ms-0 ms-xl-auto out-time-pixel`}
                        onClick={(e) => {
                          e.stopPropagation()
                        }}
                        onChange={(e) => {
                  ...
                  {/* 限時搶購 */}
                  <button
                    className={`${styles.actBtn} col m-bg-yellow pixel-border-yellow mx-4`}
                    onClick={(e) => {
                      try {
                  ...
                  {/* 熱門推薦 */}
                  <button
                    className={`${styles.actBtn} col c-bg-purple pixel-border-purple`}
                    onClick={(e) => {
                      try {
                  ...
                  >
                    <div className='d-flex flex-column flex-xl-row align-items-center'>
                      ...
                      <span
                        className={`${styles.RecCitation} ms-xl-auto pixel-font-chinese`}
                      >
                        好書都在這 !
                      </span>
                    </div>
              ...
              <div className={`${styles.phoneReciprocal} d-md-none`}>
                <select
                  className={`${styles.formSelect} d-flex mx-5 py-2 out-time-pixel`}
                  aria-label='Default select example'
                >
                  <option selected>當月</option>
