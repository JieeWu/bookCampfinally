...
router.post("/bank", async (req, res) => {
    try {
        ...
        // 新增訂單
        const ordersql = `INSERT INTO \`order\` (consignee,consignee_phone,consignee_address,total,client_id,coupon_id,delivery_id,pay_id,receipt_id,delivery_fee,other) VALUES
        (?,?,?,?,?,?,?,?,?,?,?,?)`;
        const test = await db.query(ordersql, [user, phone, address, total, cid, coupon, delivery, pay, receipt, fee, other]);
